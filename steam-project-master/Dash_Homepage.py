...
def open_nano_app_store(self):
    # Create an instance of the NanoAppStore
    nano_app = NanoAppStore()
...
from test_main import RaadHetNummer, Glagje, Dagboek, WackTheMole  # Import the game classes
